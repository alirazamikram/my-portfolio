...
const HeaderSection = ({ id }: HeaderSectionPros) => {
  ...
  return (
    <div
      className="w-full min-h-[700px] h-auto pt-[100px] tab:pt-[200px] pb-[50px] tab:pb-[100px] relative z-10 flex flex-col justify-center gap-y-8 bg-[url(/icons/box-pic.svg)] bg-no-repeat bg-contain bg-right mainContainer "
      id={id}
    >
