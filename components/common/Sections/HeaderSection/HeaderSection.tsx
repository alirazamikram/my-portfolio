...
const HeaderSection = ({ id }: HeaderSectionPros) => {
  ...
  return (
    <div
      className="flex flex-col base:flex-row justify-between items-start base:items-center gap-5 w-full min-h-[700px] h-auto pt-[100px] tab:pt-[100px] pb-[50px] tab:pb-[100px] relative z-10 mainContainer "
      id={id}
    >
